            ...
            if(requestCode == 103){
                when(position){
                    1->{
                        ...
                        val mySquadEntity = StashEntity(1, 343, name!!,key!!)
                    ...
                    2->{
                        ...
                        val mySquadEntity = StashEntity(2, 343, name!!,key!!)
                        sendEventListener.sendMessage(mySquadEntity)
                    }
                    3->{
                        ...
                        val mySquadEntity = StashEntity(3, 343, name!!,key!!)
                        sendEventListener.sendMessage(mySquadEntity)
                    }
                    4->{
                        ...
                        val mySquadEntity = StashEntity(4, 343, name!!,key!!)
                        sendEventListener.sendMessage(mySquadEntity)
                    }
                    5->{
                        ...
                        val mySquadEntity = StashEntity(5, 343, name!!,key!!)
                        sendEventListener.sendMessage(mySquadEntity)
                    }
                    6->{
                        ...
                        val mySquadEntity = StashEntity(6, 343, name!!,key!!)
                        sendEventListener.sendMessage(mySquadEntity)
                    }
                    7->{
                        ...
                        val mySquadEntity = StashEntity(7, 343, name!!,key!!)
                        sendEventListener.sendMessage(mySquadEntity)
                    }
                    8->{
                        ...
                        val mySquadEntity = StashEntity(8, 343, name!!,key!!)
                        sendEventListener.sendMessage(mySquadEntity)
                    }
                    9->{
                        ...
                        val mySquadEntity = StashEntity(9, 343, name!!,key!!)
                        sendEventListener.sendMessage(mySquadEntity)
                    }
                    10->{
                        ...
                        val mySquadEntity = StashEntity(10, 343, name!!,key!!)
                        sendEventListener.sendMessage(mySquadEntity)
                    }
                    11->{
                        ...
                        val mySquadEntity = StashEntity(11, 343, name!!,key!!)
                        sendEventListener.sendMessage(mySquadEntity)
                    }
                }
            }
